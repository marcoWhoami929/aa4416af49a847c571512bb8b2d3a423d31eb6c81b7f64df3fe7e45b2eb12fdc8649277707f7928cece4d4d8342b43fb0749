	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(views/images/slider/slide3.jpg);">
	...
	<!-- Video -->
	<section class="section-video parallax100" style="background-image: url(views/images/imagenes/14.png);">
			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-delicious size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="views/images/imagenes/7.jpg" alt="IMG-OUR">
					</div>
				</div>
			</div>
			...
			<div class="row p-t-170">
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-romantic size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="views/images/imagenes/9.jpg" alt="IMG-OUR">
					</div>
				</div>
